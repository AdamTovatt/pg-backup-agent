...
namespace PgBackupAgent.Helpers
{
    /// <summary>
    ...
    public static class EnvironmentHelper
    {
        ...
        public static string GetEnvironmentVariable(string variableName, int minLength = 0)
        {
        ...
        public static void ValidateEnvironmentVariableNames(params Type[] configurationTypes)
        {
                    ...
                    if (attribute != null)
                    {
                        ...
                        if (fieldValue != null)
                        {
                            try
                            {
                                ...
                                string value = GetEnvironmentVariable(fieldValue, attribute.MinLength);
